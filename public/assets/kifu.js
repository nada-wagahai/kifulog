...
var author$project$Kifu$Board$init = {
	scene: {pieces: _List_Nil, pos: elm$core$Maybe$Nothing, prev: elm$core$Maybe$Nothing}
};
var author$project$Model$Kifu = F7(
	function (kifuId, players, timestamp, handicap, gameName, steps, boardIds) {
		return {boardIds: boardIds, gameName: gameName, handicap: handicap, kifuId: kifuId, players: players, steps: steps, timestamp: timestamp};
	});
var author$project$Model$Timestamp = F2(
	function (start, end) {
...
var author$project$Model$initTimestamp = A2(
	author$project$Model$Timestamp,
	elm$time$Time$millisToPosix(0),
	elm$time$Time$millisToPosix(0));
var author$project$Model$initKifu = A7(author$project$Model$Kifu, '', _List_Nil, author$project$Model$initTimestamp, '', '', _List_Nil, _List_Nil);
var author$project$Kifu$Board$FIRST = {$: 'FIRST'};
var author$project$Model$Step = F7(
	function (seq, boardId, curr, player, prev, finished, notes) {
		return {boardId: boardId, curr: curr, finished: finished, notes: notes, player: player, prev: prev, seq: seq};
	});
var elm$core$Basics$False = {$: 'False'};
var author$project$Model$initStep = A7(author$project$Model$Step, 0, '', elm$core$Maybe$Nothing, author$project$Kifu$Board$FIRST, elm$core$Maybe$Nothing, false, _List_Nil);
var elm$core$Dict$RBEmpty_elm_builtin = {$: 'RBEmpty_elm_builtin'};
var elm$core$Dict$empty = elm$core$Dict$RBEmpty_elm_builtin;
var author$project$Model$initGame = {boardCache: elm$core$Dict$empty, commentInput: '', comments: _List_Nil, kModel: author$project$Kifu$Board$init, kifu: author$project$Model$initKifu, sameSteps: _List_Nil, step: author$project$Model$initStep};
...
var author$project$Route$KifuTop = function (a) {
	return {$: 'KifuTop', a: a};
};
...
var author$project$Update$SetZone = function (a) {
	return {$: 'SetZone', a: a};
};
var author$project$Update$UrlChanged = function (a) {
	return {$: 'UrlChanged', a: a};
};
var author$project$Kifu$Board$UpdateScene = function (a) {
	return {$: 'UpdateScene', a: a};
};
...
var author$project$Kifu$Board$update = F2(
	function (msg, model) {
		var scene = msg.a;
...
var author$project$Update$ApiRequest = function (a) {
	return {$: 'ApiRequest', a: a};
};
var author$project$Update$ApiResponse = F2(
	function (a, b) {
		return {$: 'ApiResponse', a: a, b: b};
	});
var author$project$Update$KifuGame = F2(
	function (a, b) {
...
var author$project$Update$KifuScene = F2(
	function (a, b) {
		return {$: 'KifuScene', a: a, b: b};
	});
...
var author$project$Update$get = function (i) {
	return A2(
...
var author$project$Update$mkScene = F2(
	function (pieces, step) {
		return {
			pieces: pieces,
			pos: A2(
				elm$core$Maybe$map,
...
var author$project$Kifu$Board$FU = {$: 'FU'};
var author$project$Kifu$Board$GIN = {$: 'GIN'};
var author$project$Kifu$Board$GYOKU = {$: 'GYOKU'};
var author$project$Kifu$Board$HISHA = {$: 'HISHA'};
var author$project$Kifu$Board$KAKU = {$: 'KAKU'};
var author$project$Kifu$Board$KEI = {$: 'KEI'};
var author$project$Kifu$Board$KIN = {$: 'KIN'};
var author$project$Kifu$Board$KYOU = {$: 'KYOU'};
var author$project$Kifu$Board$NARI_GIN = {$: 'NARI_GIN'};
var author$project$Kifu$Board$NARI_KEI = {$: 'NARI_KEI'};
var author$project$Kifu$Board$NARI_KYOU = {$: 'NARI_KYOU'};
var author$project$Kifu$Board$NULL = {$: 'NULL'};
var author$project$Kifu$Board$RYU = {$: 'RYU'};
var author$project$Kifu$Board$TO = {$: 'TO'};
var author$project$Kifu$Board$UMA = {$: 'UMA'};
var author$project$Kifu$Board$pieceFromString = function (str) {
	switch (str) {
		case 'GYOKU':
			return author$project$Kifu$Board$GYOKU;
		case 'HISHA':
			return author$project$Kifu$Board$HISHA;
		case 'RYU':
			return author$project$Kifu$Board$RYU;
		case 'KAKU':
			return author$project$Kifu$Board$KAKU;
		case 'UMA':
			return author$project$Kifu$Board$UMA;
		case 'KIN':
			return author$project$Kifu$Board$KIN;
		case 'GIN':
			return author$project$Kifu$Board$GIN;
		case 'NARI_GIN':
			return author$project$Kifu$Board$NARI_GIN;
		case 'KEI':
			return author$project$Kifu$Board$KEI;
		case 'NARI_KEI':
			return author$project$Kifu$Board$NARI_KEI;
		case 'KYOU':
			return author$project$Kifu$Board$KYOU;
		case 'NARI_KYOU':
			return author$project$Kifu$Board$NARI_KYOU;
		case 'FU':
			return author$project$Kifu$Board$FU;
		case 'TO':
			return author$project$Kifu$Board$TO;
		default:
			return author$project$Kifu$Board$NULL;
	}
};
var author$project$Kifu$Board$SECOND = {$: 'SECOND'};
var author$project$Kifu$Board$playerFromString = function (str) {
	if (str === 'SECOND') {
		return author$project$Kifu$Board$SECOND;
	} else {
...
var author$project$Update$Decoder$order = function (label) {
	return A2(
		elm$json$Json$Decode$map,
		author$project$Kifu$Board$playerFromString,
		A3(author$project$Update$Decoder$fieldDefault, label, 'FIRST', elm$json$Json$Decode$string));
};
...
var author$project$Update$Decoder$pos = function (label) {
	var f = F2(
		function (x, y) {
			return ((!x) || (!y)) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
				{x: x, y: y});
		});
	return A3(
		elm$core$Basics$composeL,
	...
	return A2(
		...
		elm$json$Json$Decode$list(
			A4(
				...
				author$project$Kifu$Board$Piece,
				A2(
					elm$json$Json$Decode$map,
...
var author$project$Update$Decoder$players = elm$json$Json$Decode$list(
	A3(
		elm$json$Json$Decode$map2,
...
var author$project$Update$Decoder$sameSteps = elm$json$Json$Decode$list(
	A5(
		...
		A2(
			elm$json$Json$Decode$map,
			function (i) {
				return elm$time$Time$millisToPosix(i * 1000);
			},
			A2(elm$json$Json$Decode$field, 'startTs', elm$json$Json$Decode$int))));
var author$project$Update$Decoder$board = A4(
	elm$json$Json$Decode$map3,
	F3(
		function (a, b, c) {
...
var author$project$Update$Decoder$kifu = function (kifuId) {
	return A7(
		elm$json$Json$Decode$map6,
		author$project$Model$Kifu(kifuId),
		A2(elm$json$Json$Decode$field, 'players', author$project$Update$Decoder$players),
		A3(
			elm$json$Json$Decode$map2,
			author$project$Model$Timestamp,
			...
			A2(
				...
				A2(elm$json$Json$Decode$field, 'endTs', elm$json$Json$Decode$int))),
		A2(elm$json$Json$Decode$field, 'handicap', elm$json$Json$Decode$string),
		A2(elm$json$Json$Decode$field, 'gameName', elm$json$Json$Decode$string),
		A2(
			elm$json$Json$Decode$field,
			'steps',
			elm$json$Json$Decode$list(author$project$Update$Decoder$step)),
		A2(
			elm$json$Json$Decode$field,
			'boardIds',
			elm$json$Json$Decode$list(elm$json$Json$Decode$string)));
	...
	function (model, req) {
		switch (req.$) {
			case 'KifuScene':
				...
				if (_n12.$ === 'Nothing') {
					...
					return A5(
						...
						model,
						elm$core$Basics$always(board.scene),
						comments,
						steps,
						seq);
				}
			case 'KifuGame':
				var kifuId = req.a;
				var seq = req.b;
				return _Utils_eq(model.game.kifu.kifuId, kifuId) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					model,
					elm$http$Http$get(
						{
							expect: elm$http$Http$expectString(
				...
				var body = elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'kifu_id',
							elm$json$Json$Encode$string(game.kifu.kifuId)),
							_Utils_Tuple2(
							'seq',
							elm$json$Json$Encode$int(game.step.seq))
						]));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							game: _Utils_update(
								game,
								{
									boardCache: A2(elm$core$Dict$remove, boardId, game.boardCache),
									commentInput: ''
								})
						}),
					elm$http$Http$post(
...
var author$project$Update$apiResponse = F3(
	function (model, res, result) {
		if (result.$ === 'Ok') {
			var text = result.a;
			switch (res.$) {
				case 'KifuScene':
					...
					if (_n6.$ === 'Ok') {
						...
						return A5(
							author$project$Update$updateScene,
							model,
							author$project$Update$mkScene(pieces),
							comments,
							steps,
							seq);
					} else {
								...
								_Utils_update(
									model,
									{
										game: _Utils_update(
											game,
											{
												boardCache: elm$core$Dict$empty,
												kifu: _Utils_update(
													kifu,
													{steps: steps})
											})
		...
		while (true) {
			switch (msg.$) {
					...
					switch (_n1.$) {
						case 'Kifu':
							...
							if (_Utils_eq(m.game.kifu.kifuId, kifuId)) {
								...
								var $temp$msg = author$project$Update$ApiRequest(
									A2(author$project$Update$KifuGame, kifuId, seq)),
									$temp$model = m;
								msg = $temp$msg;
								model = $temp$model;
								continue update;
						...
						case 'KifuTop':
							var kifuId = _n1.a;
							var $temp$msg = author$project$Update$LinkClicked(
				...
				case 'KifuMsg':
					var kifuMsg = msg.a;
					var game = model.game;
					var _n2 = A2(author$project$Kifu$Board$update, kifuMsg, game.kModel);
					var kModel_ = _n2.a;
					var kMsg = _n2.b;
					var game_ = function () {
						var _n3 = A2(author$project$Update$get, game.step.seq, game.kifu.boardIds);
						if (_n3.$ === 'Nothing') {
							return _Utils_update(
								game,
								{kModel: kModel_});
							...
							return _Utils_update(
								game,
								{
									boardCache: A3(
										...
										boardId,
										_Utils_Tuple3(kModel_, game.comments, game.sameSteps),
										game.boardCache),
									kModel: kModel_
								});
						}
				...
				case 'ApiResponse':
					var res = msg.a;
					var result = msg.b;
					return A3(author$project$Update$apiResponse, model, res, result);
				case 'SetZone':
					var zone = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$Update$updateScene = F5(
	function (model, sceneF, comments, steps, seq) {
		var game = model.game;
		var step = (!seq) ? author$project$Model$initStep : A2(
			elm$core$Maybe$withDefault,
			author$project$Model$initStep,
			A2(author$project$Update$get, seq - 1, game.kifu.steps));
		return A2(
			author$project$Update$update,
			author$project$Update$KifuMsg(
				author$project$Kifu$Board$UpdateScene(
					sceneF(step))),
			_Utils_update(
				model,
				{
					game: _Utils_update(
						game,
						{comments: comments, sameSteps: steps, step: step})
				}));
	});
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var _n0 = A2(
			author$project$Update$update,
			author$project$Update$UrlChanged(url),
			{
				count: 0,
				...
				login: flags,
				route: author$project$Route$toRoute(url),
				timeZone: _Utils_Tuple2(
					elm$time$Time$utc,
					elm$time$Time$Name('UTC')),
				url: url
			});
		var m1 = _n0.a;
		var c1 = _n0.b;
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(
						elm$core$Task$perform,
						author$project$Update$SetZone,
						A3(elm$core$Task$map2, elm$core$Tuple$pair, elm$time$Time$here, elm$time$Time$getZoneName)),
						c1
					])));
	});
...
var author$project$Kifu$Board$pieceText = function (type_) {
	switch (type_.$) {
		case 'GYOKU':
			return '玉';
		case 'HISHA':
...
var author$project$Kifu$Board$writingModeVirticalRl = mdgriffith$elm_ui$Element$htmlAttribute(
...
var author$project$Kifu$Board$capturedAttrs = function (player) {
	var attrs = _List_fromArray(
		[
			author$project$Kifu$Board$writingModeVirticalRl,
			A2(mdgriffith$elm_ui$Element$paddingXY, 5, 15)
		]);
	return _Utils_eq(player, author$project$Kifu$Board$FIRST) ? A2(elm$core$List$cons, mdgriffith$elm_ui$Element$alignBottom, attrs) : A2(
		elm$core$List$cons,
		mdgriffith$elm_ui$Element$rotate(elm$core$Basics$pi),
		A2(elm$core$List$cons, mdgriffith$elm_ui$Element$alignTop, attrs));
};
var author$project$Kifu$Board$alt = F2(
	function (ma, mb) {
		if (ma.$ === 'Just') {
			return ma;
		} else {
...
var author$project$Kifu$Board$pieceAttrs = function (player) {
	var attrs = _List_fromArray(
		[
...
var author$project$Kifu$Board$pieceMap = function (list) {
...
var author$project$Kifu$Board$field = F3(
	function (pieces, curr, prev) {
		var pMap = author$project$Kifu$Board$pieceMap(pieces);
		var defPiece = A3(author$project$Kifu$Board$Piece, author$project$Kifu$Board$NULL, elm$core$Maybe$Nothing, author$project$Kifu$Board$FIRST);
		var p = F2(
			function (x, y) {
				return A2(
					elm$core$Maybe$withDefault,
					...
					function (x) {
						return A2(
							...
							A2(
								elm$core$List$map,
								function (y) {
									var prevColor = A3(mdgriffith$elm_ui$Element$rgb255, 215, 225, 221);
									var piece = A2(p, x, y);
									var defColor = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
									var currColor = A3(mdgriffith$elm_ui$Element$rgb255, 199, 209, 205);
									var bgcolor = F2(
										function (mpos, color) {
											return A2(
												elm$core$Maybe$andThen,
												function (pos) {
													return (_Utils_eq(x, pos.x) && _Utils_eq(y, pos.y)) ? elm$core$Maybe$Just(color) : elm$core$Maybe$Nothing;
												},
												mpos);
										});
									var bg = F2(
										function (mpos, mprev) {
											return mdgriffith$elm_ui$Element$Background$color(
												A2(
													...
													defColor,
													A2(
														author$project$Kifu$Board$alt,
														A2(bgcolor, mpos, currColor),
														A2(bgcolor, mprev, prevColor))));
										});
									return A2(
										mdgriffith$elm_ui$Element$el,
										A2(
											elm$core$List$cons,
											A2(bg, curr, prev),
											author$project$Kifu$Board$pieceAttrs(piece.player)),
										A2(
											mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[mdgriffith$elm_ui$Element$centerX, mdgriffith$elm_ui$Element$centerY]),
											mdgriffith$elm_ui$Element$text(
												author$project$Kifu$Board$pieceText(piece.type_))));
								},
...
var author$project$Kifu$Board$board = function (scene) {
	var fontSize = mdgriffith$elm_ui$Element$Font$size(12);
	var headColumn = A2(
		elm$core$Basics$composeL,
		mdgriffith$elm_ui$Element$el(
			_List_fromArray(
		...
		mdgriffith$elm_ui$Element$el(
			_List_fromArray(
				[mdgriffith$elm_ui$Element$centerY, fontSize])));
	var headRow = A2(
		elm$core$Basics$composeL,
		mdgriffith$elm_ui$Element$el(
			_List_fromArray(
		...
		mdgriffith$elm_ui$Element$el(
			_List_fromArray(
				[mdgriffith$elm_ui$Element$centerX, fontSize])));
	var _n0 = A2(
		elm$core$List$partition,
		function (p) {
			return _Utils_eq(p.player, author$project$Kifu$Board$FIRST);
		},
		A2(
			elm$core$List$filter,
			function (p) {
				return _Utils_eq(p.pos, elm$core$Maybe$Nothing);
			},
			scene.pieces));
	var capturedFirst = _n0.a;
	var capturedSecond = _n0.b;
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2(
								elm$core$Basics$composeL,
								A2(elm$core$Basics$composeL, headRow, mdgriffith$elm_ui$Element$text),
						...
						_List_fromArray(
							[
								A3(author$project$Kifu$Board$field, scene.pieces, scene.pos, scene.prev),
								A2(
								mdgriffith$elm_ui$Element$column,
								_List_Nil,
								A2(
									...
									A2(
										...
										A2(
											elm$core$Basics$composeL,
											A2(elm$core$Basics$composeL, headColumn, mdgriffith$elm_ui$Element$text),
											elm$core$String$fromList),
										elm$core$List$singleton),
									elm$core$String$toList('一二三四五六七八九')))
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$el,
...
var author$project$Kifu$Board$viewElm = F2(
	function (model, toMsg) {
		return A2(
			mdgriffith$elm_ui$Element$map,
			toMsg,
			author$project$Kifu$Board$board(model.scene));
	});
var author$project$Update$NopMsg = {$: 'NopMsg'};
...
var author$project$View$controlView = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		elm$core$List$concat(
			_List_fromArray(
				[
					(!model.game.step.seq) ? _List_Nil : _List_fromArray(
					[
						A2(
							...
							]),
						{
							...
							url: elm$core$String$fromInt(model.game.step.seq - 1)
						})
					]),
					model.game.step.finished ? _List_Nil : _List_fromArray(
					[
						A2(
						mdgriffith$elm_ui$Element$link,
						_List_fromArray(
...
var author$project$View$playersToStr = function (players) {
	return A2(
		elm$core$String$join,
		', ',
		A2(
...
var author$project$View$playersView = function (players) {
	var _n0 = A2(
		elm$core$List$partition,
		function (p) {
	...
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$text(
				'☗先手: ' + author$project$View$playersToStr(firsts)),
				mdgriffith$elm_ui$Element$text(
				'☖後手: ' + author$project$View$playersToStr(seconds))
			]));
};
var author$project$View$monthNumber = function (month) {
	switch (month.$) {
		case 'Jan':
			return 1;
		case 'Feb':
...
var author$project$View$zoneStr = function (zone) {
	if (zone.$ === 'Name') {
		var str = zone.a;
		return '(' + (str + ')');
	} else {
		...
		return _Utils_ap(
			(min < 0) ? '' : '+',
			elm$core$String$fromFloat(min / 60));
	}
};
...
var author$project$View$posixToStr = F2(
	function (t, _n0) {
		var tz = _n0.a;
		var zname = _n0.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$core$String$fromInt(
							A2(elm$time$Time$toYear, tz, t)),
							elm$core$String$fromInt(
							author$project$View$monthNumber(
								A2(elm$time$Time$toMonth, tz, t))),
							elm$core$String$fromInt(
							A2(elm$time$Time$toDay, tz, t))
						])),
					A2(
					elm$core$String$join,
					':',
					_List_fromArray(
						[
							elm$core$String$fromInt(
							A2(elm$time$Time$toHour, tz, t)),
							elm$core$String$fromInt(
							A2(elm$time$Time$toMinute, tz, t)),
							elm$core$String$fromInt(
							A2(elm$time$Time$toSecond, tz, t))
						])),
					author$project$View$zoneStr(zname)
				]));
	});
var author$project$View$timestampView = F2(
	function (t, tz) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text(
					'開始時刻: ' + A2(author$project$View$posixToStr, t.start, tz))
				]));
	});
...
var author$project$View$gameInfo = F2(
	function (tz, game) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A2(author$project$View$timestampView, game.timestamp, tz),
					author$project$View$playersView(game.players),
					mdgriffith$elm_ui$Element$text('手割合: ' + game.handicap),
					mdgriffith$elm_ui$Element$text('棋戦: ' + game.gameName)
				]));
	});
var author$project$Kifu$Board$playerToSymbol = function (player) {
	if (player.$ === 'FIRST') {
		return '☗';
	} else {
		return '☖';
...
var author$project$View$boardView = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2(author$project$View$gameInfo, model.timeZone, model.game.kifu),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2(author$project$Kifu$Board$viewElm, model.game.kModel, author$project$Update$KifuMsg),
						A3(author$project$View$stepsView, model, model.game.step.seq, model.game.kifu)
					])),
				author$project$View$stepView(model.game.step),
				A2(
				...
				{
					label: mdgriffith$elm_ui$Element$Input$labelHidden('notes'),
					onChange: elm$core$Basics$always(author$project$Update$NopMsg),
					placeholder: elm$core$Maybe$Just(
						A2(
							mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							mdgriffith$elm_ui$Element$text('棋譜コメント'))),
					spellcheck: false,
					text: A2(elm$core$String$join, '\n', model.game.step.notes)
				}),
				author$project$View$controlView(model)
			]));
};
...
var author$project$View$commentsView = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var author$project$View$sameSteps = function (model) {
	var stepLink = function (step) {
		var _n0 = A2(
			elm$core$List$partition,
			function (p) {
				return _Utils_eq(p.order, author$project$Kifu$Board$FIRST);
		...
		return A2(
				...
				]),
			{
				...
				url: '../' + (step.kifuId + ('/' + elm$core$String$fromInt(step.seq)))
			});
	};
	...
	return A2(
		...
		A2(
			...
			elm$core$List$isEmpty(steps) ? _List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('なし')
				]) : _List_fromArray(
				[
					A2(
					mdgriffith$elm_ui$Element$table,
						...
						]),
					{
						columns: _List_fromArray(
							[
								{header: mdgriffith$elm_ui$Element$none, view: stepLink, width: mdgriffith$elm_ui$Element$shrink},
								{
								header: mdgriffith$elm_ui$Element$none,
								view: function (step) {
									return mdgriffith$elm_ui$Element$text(
										elm$core$String$fromInt(step.seq) + '手');
								},
								width: mdgriffith$elm_ui$Element$shrink
							},
								{
								...
								view: function (step) {
									return mdgriffith$elm_ui$Element$text(
										A2(author$project$View$posixToStr, step.start, model.timeZone));
								},
								width: mdgriffith$elm_ui$Element$shrink
							}
							]),
